...
import { sendProcessedDataToExport } from "./rabbitmqPublisher";
...
export const consumeAndProcessData = async () => {
  try {
    ...
    channel.consume(queueName, async (msg) => {
      if (msg !== null) {
        ...
        const processedData = await processAI(decryptedData);
        console.log("Processed data:", processedData);

        await sendProcessedDataToExport(processedData);
        console.log("Processed data sent to Export Microservice.");
